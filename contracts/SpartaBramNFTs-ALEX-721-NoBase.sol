...
contract SpartaBramAlexNoBase is
    ERC721,
    ERC721Enumerable,
    Pausable,
    AccessControl,
    ERC721Burnable
{
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://uris.spartanprotocol.org/spartabram-alex/";
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://uris.spartanprotocol.org/spartabram-alex/ContractUri.json";
    }
